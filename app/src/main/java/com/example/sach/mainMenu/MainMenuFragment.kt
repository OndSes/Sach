...
/**
 * hlavná obrazovka, ktorá presmerováva na iné obrazovky
 */
class MainMenuFragment : Fragment(R.layout.fragment_main_menu) {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val chessButton = view.findViewById<Button>(R.id.chessButton)

        val checkersButton = view.findViewById<Button>(R.id.checkersButton)
