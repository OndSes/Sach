...
/**
 * herná obrazovka, ktorá vytvorí ViewModel pre danú hru a renderer
 */
class GameFragment : Fragment(R.layout.fragment_game) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val gameType = requireArguments().getString("game_type")!!
        ...
        viewModel.createGame(gameType, settings)
